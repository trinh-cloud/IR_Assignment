...
# Hàm vô hiệu hóa stdout để giữ terminal sạch 100% khi load thư viện hay chạy script trung gian
class HiddenPrints:
    def __enter__(self):
...
def run_evaluation_pipeline():
    # 1. Ẩn toàn bộ log khởi tạo và fetching
    with HiddenPrints():
    ...
    # 2. Output kết quả tĩnh dưới dạng bảng Markdown (Không log verbose)
